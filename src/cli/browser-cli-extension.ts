...
export async function installChromeExtension(opts?: {
  ...
  if (!hasManifest(src)) {
    throw new Error("Bundled Chrome extension is missing. Reinstall CryptoClaw and try again.");
  }
      ...
      defaultRuntime.error(
        info(
          [
            ...
            `- Pin “CryptoClaw Browser Relay”, then click it on the tab (badge shows ON)`,
            "",
