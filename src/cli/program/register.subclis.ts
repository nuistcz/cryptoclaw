...
const entries: SubCliEntry[] = [
  ...
  {
    name: "docs",
    description: "Search the live CryptoClaw docs",
    hasSubcommands: false,
    register: async (program) => {
  ...
  {
    name: "plugins",
    description: "Manage CryptoClaw plugins and extensions",
    hasSubcommands: true,
    register: async (program) => {
  ...
  {
    name: "update",
    description: "Update CryptoClaw and inspect update channel status",
    hasSubcommands: true,
    register: async (program) => {
