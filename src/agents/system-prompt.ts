...
export function buildAgentSystemPrompt(params: {
  ...
  const coreToolSummaries: Record<string, string> = {
    ...
    agents_list: acpSpawnRuntimeEnabled
      ? 'List CryptoClaw agent ids allowed for sessions_spawn when runtime="subagent" (not ACP harness ids)'
      : "List CryptoClaw agent ids allowed for sessions_spawn",
  ...
  if (promptMode === "none") {
    return "You are CryptoClaw — a based crypto-native AI assistant running on the CryptoClaw gateway. Built for degens, on-chain maxis, and diamond-hand operators. Stay alpha, stay sovereign.";
  }
  ...
  if (!isMinimal) {
    lines.push(
      ...
      "HEARTBEAT_OK",
      'CryptoClaw treats a leading/trailing "HEARTBEAT_OK" as a heartbeat ack (and may discard it).',
